...
import { CodeInputAuthComponent } from './components/code-input-auth/code-input-auth.component';
...
import { EarnedSattPipe } from './pipes/earned-satt.pipe';
import { TransfomNumberPipe } from './pipes/transfom-number.pipe';
import { ClickElseWhereDirective } from './directives/click-else-where.directive';
import { CapitalizePhrasePipe } from './pipes/capitalize-phrase.pipe';
import { ConvertToWeiPipe } from './pipes/convert-to-wei.pipe';
import { ConvertFromWei } from './pipes/wei-to-sa-tt.pipe';
...
import { FarmPostCardComponent } from './../campaigns/components/farm-post-card/farm-post-card.component';
import { ResetBtnDirective } from './components/multi-select/reset-btn.directive';
import { OptionDirective } from './components/multi-select/option.directive';
import { ItemsListDirective } from './components/list-items/items-list.directive';
...
import { FooterSendReceiveBuyComponent } from './../wallet/components/footer-send-receive-buy/footer-send-receive-buy.component';
import { DropdownCryptoNetworkComponent } from './../wallet/components/dropdown-crypto-network/dropdown-crypto-network.component';
