...
export class ProposalDetailsComponent implements OnInit {
  ...
  ipfsHash!: any;
  formattedAuthor: string | undefined;
  formattedIpfsHash: string | undefined;
  ...
  async ngOnInit() {
    ...
    this.formattedAuthor = `${this.proposal.author.substr(0, 4)}...${this.proposal.author.substr(-3)}`;
    this.formattedIpfsHash = `${this.ipfsHash.substr(0, 4)}...${this.ipfsHash.substr(-3)}`;
  }
